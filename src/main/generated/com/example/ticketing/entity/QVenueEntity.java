...
public class QVenueEntity extends EntityPathBase<VenueEntity> {
    ...
    private static final long serialVersionUID = -954671248L;
    ...
    public final EnumPath<com.example.ticketing.type.VenueType> venueType = createEnum("venueType", com.example.ticketing.type.VenueType.class);
