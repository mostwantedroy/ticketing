...
import com.example.ticketing.properties.JwtProperties;
...
public class JwtUtils {
	...
	private static Map<String, Claim> decodeJwtToken(String jwtToken) {
		...
		try {
			...
			throw new ReservationException(ErrorCode.INVALID_TOKEN);
		} catch (TokenExpiredException e) {
			throw new ReservationException(ErrorCode.EXPIRED_TOKEN);
		}
	}
}
